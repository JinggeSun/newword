package com.sun.learn.relational.util;
...
public class WebLogData {
    ...
    public static DataSet<Tuple2<String,String>> getDocumentDataSet(ExecutionEnvironment env){
        ...
        Arrays.stream(DOCUMENTS).forEach(w->list.add(new Tuple2<String,String>((String)w[0],(String)w[1])));
     ...
     * @return
     */
    public static DataSet<Tuple3<Integer,String,Integer>> getRankDateSet(ExecutionEnvironment env){
        List<Tuple3<Integer,String,Integer>> list = new ArrayList<>();
        Arrays.stream(RANKS).forEach(w->list.add(new Tuple3<Integer, String, Integer>((Integer)w[0], (String) w[1], (Integer) w[2])));
        return env.fromCollection(list);
    }
